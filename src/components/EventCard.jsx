                ...
                <div className="cursor-pointer rounded-md shadow-lg bg-white dark:bg-gray-800 relative">
                    <div className="py-5">
                        <div className="px-6">
                            ...
                            <p className="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">New
                                Year Costume Party</p>
                        </div>
                        <div className="mt-5 px-6">
                            <p className="text-xs text-gray-400">Day</p>
                            <p className="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">Tuesday,
                                9:00pm - 11:00pm</p>
                        </div>
                        <div className="mt-5 px-6">
                            <p className="text-xs text-gray-400">Date</p>
                            <p className="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">14th
                                September 2020</p>
                        </div>
                        ...
                        <div className="mt-5 px-6 flex items-center text-gray-700 dark:text-gray-400">
                            ...
                            <p/>
                            <svg className="ml-3.5 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width={16}
                                 height={16} viewBox="0 0 16 16" fill="none">
                                <rect x="5.33331" y="5.33301" width={8} height={8} rx="1.33333" stroke="currentColor"
